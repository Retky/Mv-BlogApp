...
RSpec.describe 'Post index page', type: :feature do
  it 'should show the user profile picture' do
    ...
    Post.create(title: 'Post1', text: 'Text1', author_id: user.id)
  ...
  it 'should show the number of posts' do
    user = User.create(name: 'John', photo: '', bio: 'Something')
    Post.create(title: 'Post1', text: 'Text1', author_id: user.id)
    Post.create(title: 'Post2', text: 'Text2', author_id: user.id)
    visit "/users/#{user.id}/posts"
  ...
  it 'should show the next two post\'s title' do
    ...
    Post.create(title: 'Post1', text: 'Text1', author_id: user.id)
    Post.create(title: 'Post2', text: 'Text2', author_id: user.id)
    Post.create(title: 'Post3', text: 'Text3', author_id: user.id)
    Post.create(title: 'Post4', text: 'Text4', author_id: user.id)
    visit "/users/#{user.id}/posts"
  ...
  it 'should show the post\'s comments' do
    ...
    Comment.create(author_id: user2.id, post_id: post1.id, text: 'Comment1')
    visit "/users/#{user.id}/posts"
  ...
  it 'should show the pagination' do
    ...
    Post.create(title: 'Post3', text: 'Text3', author_id: user.id)
    Post.create(title: 'Post4', text: 'Text4', author_id: user.id)
    Post.create(title: 'Post5', text: 'Text5', author_id: user.id)
    visit "/users/#{user.id}/posts"
